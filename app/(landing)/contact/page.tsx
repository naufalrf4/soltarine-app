            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                  Connect with Soltarine for innovative solar energy solutions.
                  Explore how our services can enhance your sustainability
                  efforts and reduce energy costs. We re here to assist with any
